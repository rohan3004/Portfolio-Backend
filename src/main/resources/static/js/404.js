...
const execute = function executeCommand(input) {
    ...
    terminalOutput.innerHTML = `${terminalOutput.innerHTML}<p class="out_code"><span class="arrow green">api.rohandev.online:</span><span class="blue">~/404</span>$ ${input}<br>${output}</p>`;
